...
type SelectedEventCategories = SelectedEventCategories {
        selectedAcademic : Bool 
    ,   selectedWork : Bool
    ,   selectedProject : Bool
    ,   selectedAward : Bool 
    }
...
isEventCategorySelected category current =
    let
        selected = case current of SelectedEventCategories s -> s
    in
    case category of
       Academic -> selected.selectedAcademic
       Work -> selected.selectedWork
       Project -> selected.selectedProject
       Award -> selected.selectedAward
...
set category value current =
    ...
    in
    case category of
       Academic -> SelectedEventCategories { selected | selectedAcademic = value }
       Work -> SelectedEventCategories { selected | selectedWork = value }
       Project -> SelectedEventCategories { selected | selectedProject = value }
       Award -> SelectedEventCategories { selected | selectedAward = value }
...
view model =
    let
        selected = case model of SelectedEventCategories s -> s
    in
    div [] [
        checkbox "Academic" selected.selectedAcademic Academic
    ,   checkbox "Work" selected.selectedWork Work
    ,   checkbox "Project" selected.selectedProject Project
    ,   checkbox "Award" selected.selectedAward Award
    ]
