...
import Model.Event exposing (categoryView)
...
getRepositories = Http.get {
        url = "https://api.github.com/users/ShinonL/repos"
...
update msg model =
    case msg of
        ...
        GotRepos res ->
            case res of
               Ok repositories -> ( { model | repos = repositories }, Cmd.none )
